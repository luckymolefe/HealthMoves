<?php
	...
	if(!empty($_SESSION['customer']['token'])) { //if customer session set,
		header("Location: index.php"); //then redirect to customer welcome page
		exit();
	}
?>
<!DOCTYPE html>
<html>
<head>
	<title>Healthy Moves | LOGIN</title>
...
<body>
	<?php
		...
		switch ($action) {
			case 'invalid':
				echo '<div class="alert-message error">Incorrect login details!</div>';
				break;
			case 'success':
				echo '<div class="alert-message success">Successfully logged out!</div>';
				break;
			case 'null':
	...
	<div class="login-container">
		...
		<form action="router.php" method="POST" enctype="application/www-forms-urlencoded">
			<div class="input-group">
				...
				<input type="email" name="email" class="input-controls" placeholder="Enter username" autocomplete="off" autofocus required>
			</div>
			<div class="input-group">
